...
@section('content')
<h1 style="margin-top: 75px;">Ubah Data Siswa</h1>
...
<a href="" style="text-decoration: none">Ubah Data Siswa</a>
<form style="margin-top:20px" action="{{ route('student.update', $students['id']) }}" method="POST" class="card p-5">
    @method('PATCH')
    @csrf

    <div class="mb-3 row">
        <label for="nis" class="col-sm-2 col-form-label">Nis</label>
        <input value="{{ $students['nis'] }}" type="number" class="form-control" name="nis" id="nis">
    </div>
    <div class="mb-3 row">
        <label for="name" class="col-sm-2 col-form-label">Nama</label>
        <input value="{{ $students['name'] }}" class="form-control" name="name" id="name">
    </div>
    <div class="mb-3 row">
