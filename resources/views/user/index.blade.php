...
<div class="container">
    ...
    <a style="margin-bottom: 25px; float: right;" class="btn btn-primary" href="{{ route('user.create') }}">Daftar <i class='bx bx-plus bx-spin'></i></a>
        ...
        <tbody>
            ...
            <tr>                    
                ...
                <td class="d-flex justify-content-center">
                    <a href="{{ route('user.edit', $user['id']) }}" class="btn btn-primary me-3"><i class='bx bx-edit bx-tada'></i></a>
